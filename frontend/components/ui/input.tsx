  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-md border-[1.5px] border-border-strong/55 bg-surface px-4 py-2 text-sm text-text shadow-[1px_2px_0_hsl(var(--text)/calc(0.08*var(--shadow-strength)))] transition-all",
